...
def inarow_3east(ch, r_start, c_start, A):
    """Starts from r_start and c_start and check for three-in-a-row eastward of element ch, returning True or False
    """
...
def inarow_3south(ch, r_start, c_start, A):
    """Starts from r_start and c_start and check for three-in-a-row southward of element ch, returning True or False
    """
...
def inarow_3southeast(ch, r_start, c_start, A):
    """Start from r_start and c_start and check for three-in-a-row southeastward of element ch, returning True or False
    """
    num_rows = len(A)      # Number of rows is len(A)
    num_cols = len(A[0])   # Number of columns is len(A[0])
...
def inarow_3northeast(ch, r_start, c_start, A):
    """Start from r_start and c_start and check for three-in-a-row northeastward of element ch, returning True or False
    """
    num_rows = len(A)      # Number of rows is len(A)
    num_cols = len(A[0])   # Number of columns is len(A[0])
